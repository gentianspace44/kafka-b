...
{
    public class BluVoucherKafkaConsumer : IVpsKafkaConsumer
    {
        ...
        public BluVoucherKafkaConsumer(IClientBalanceService clientBalanceService,
        ...
        public async Task<bool> ConsumeAndProcessTransaction(string message)
        {
            ...
            try
            {
                ...
                var nullablePayload = JsonConvert.DeserializeObject<KafkaQueuePayload<BluVoucherRedeemRequest>>(message);
                ...
                KafkaQueuePayload<BluVoucherRedeemRequest> requestObject = nullablePayload!;
        ...
        private async Task<CreditOnSyxResult> CreditOnSyx(KafkaQueuePayload<BluVoucherRedeemRequest> requestObject)
        {
        ...
        private bool IsPayloadValid(KafkaQueuePayload<BluVoucherRedeemRequest>? queuePayload)
        {
