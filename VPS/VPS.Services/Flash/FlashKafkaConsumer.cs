...
{
    public class FlashKafkaConsumer : IVpsKafkaConsumer
    {
        private readonly ILoggerAdapter<FlashKafkaConsumer> _logger;
        ...
        public FlashKafkaConsumer(IClientBalanceService clientBalanceService,
           ILoggerAdapter<FlashKafkaConsumer> logger,
        ...
        public async Task<bool> ConsumeAndProcessTransaction(string message)
        {
            ...
            try
            {
                ...
                var nullablePayload = JsonConvert.DeserializeObject<KafkaQueuePayload<FlashRedeemRequest>>(message);
                ...
                KafkaQueuePayload<FlashRedeemRequest> requestObject = nullablePayload!;
        ...
        private async Task<CreditOnSyxResult> CreditOnSyx(KafkaQueuePayload<FlashRedeemRequest> requestObject)
        {
        ...
        private bool IsPayloadValid(KafkaQueuePayload<FlashRedeemRequest>? queuePayload)
        {
