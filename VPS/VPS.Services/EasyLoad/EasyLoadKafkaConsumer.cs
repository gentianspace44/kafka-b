...
{
    public class EasyLoadKafkaConsumer : IVpsKafkaConsumer
    {

        private readonly ILoggerAdapter<EasyLoadKafkaConsumer> _logger;
        ...
        public EasyLoadKafkaConsumer(IClientBalanceService clientBalanceService,
            ILoggerAdapter<EasyLoadKafkaConsumer> logger,
        ...
        public async Task<bool> ConsumeAndProcessTransaction(string message)
        {
            ...
            try
            {
                ...
                var nullablePayload = JsonConvert.DeserializeObject<KafkaQueuePayload<EasyLoadVoucherRedeemRequest>>(message);

                if (!IsPayloadValid(nullablePayload))
                {
                    return false;
                }
                KafkaQueuePayload<EasyLoadVoucherRedeemRequest> requestObject = nullablePayload!;
        ...
        private async Task<CreditOnSyxResult> CreditOnSyx(KafkaQueuePayload<EasyLoadVoucherRedeemRequest> requestObject)
        {
        ...
        private bool IsPayloadValid(KafkaQueuePayload<EasyLoadVoucherRedeemRequest>? queuePayload)
        {
